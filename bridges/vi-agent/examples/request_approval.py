...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Example hook that reuses a vi-agent daemon identity to ask PI for approval."
    )
...
def main() -> int:
    ...
    if not args.state_file:
        raise SystemExit("Missing --state-file or VI_AGENT_STATE_FILE")
