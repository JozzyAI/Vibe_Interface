    ...
    <>
      ...
      >
        <div className="project-sidebar__compact-hdr">
          <span className="project-sidebar__sect-label">Workspace</span>
        </div>

        <div className="project-sidebar__sessions px-3 pb-3">
          <button
            type="button"
          ...
          >
            ...
            <span
              className={cn(
                ...
                pathname === "/agents" && "project-sidebar__sess-label--active",
              )}
            >
              Agents Connector
            </span>
            <span className="project-sidebar__sess-status">connect</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span
              className={cn(
                "project-sidebar__sess-label",
                pathname === "/ideas" && "project-sidebar__sess-label--active",
              )}
            >
              Ideas
            </span>
            <span className="project-sidebar__sess-status">notebook</span>
          </button>
          <button
            type="button"
            onClick={() => navigate("/approval-hub")}
            className={cn(
              "project-sidebar__sess-row",
          ...
          >
            ...
            <span
              className={cn(
                "project-sidebar__sess-label",
                pathname === "/approval-hub" && "project-sidebar__sess-label--active",
              )}
            >
              Approvals
            </span>
            <span className="project-sidebar__sess-status">hub</span>
          </button>
        </div>

        <div className="project-sidebar__compact-hdr border-t border-[var(--color-border-default)]">
